...
import (
	...
	metadata "github.com/google/osv-scalibr/extractor/filesystem/misc/firefox/extensions"
...
var (
	metadataStruct1 = &metadata.Metadata{
		...
		SourceURI:    "https://example.com/extension.xpi",
		InstallDate:  1740566188000,
		UpdateDate:   1740567000000,
		SignedState:  2,
		Active:       true,
		UserDisabled: false,
		AppDisabled:  false,
	}
	metadataProto1 = &pb.FirefoxExtensionsMetadata{
		Name:         "Test Extension",
		Description:  "Test Description",
		Creator:      "Test Creator",
		HomepageUrl:  "https://example.com/home",
...
func TestToProto(t *testing.T) {
	testCases := []struct {
		desc string
		m    *metadata.Metadata
		want *pb.FirefoxExtensionsMetadata
	}{
		{
			desc: "set_metadata",
			m:    metadataStruct1,
...
func TestToStruct(t *testing.T) {
	testCases := []struct {
		desc string
		m    *pb.FirefoxExtensionsMetadata
